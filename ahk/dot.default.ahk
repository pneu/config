...
!^#1::
	...
	MoveToX := (Mon1Left + Mon1Right) // 2
	MoveToY := (Mon1Top + Mon1Bottom) // 2
...
!^#2::
	...
	MoveToX := (Mon2Left + Mon2Right) // 2
	MoveToY := (Mon2Top + Mon2Bottom) // 2
	;MsgBox, MoveToX: %MoveToX% -- MoveToY: %MoveToY%
	MouseMove, MoveToX, MoveToY
	return
...
!^#3::
	...
	MoveToX := (Mon3Left + Mon3Right) // 2
	MoveToY := (Mon3Top + Mon3Bottom) // 2
	;MsgBox, MoveToX: %MoveToX% -- MoveToY: %MoveToY%
	MouseMove, MoveToX, MoveToY
	return
